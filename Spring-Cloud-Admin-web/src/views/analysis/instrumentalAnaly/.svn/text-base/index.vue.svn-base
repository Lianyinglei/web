<template>
	<div class="app-container calendar-list-container">
		<div style="border-bottom: 1px solid #ccc;height:30px;line-height: 30px;">仪器状态统计</div>
        ...
        <div style="border-bottom: 1px solid #ccc;height:30px;line-height: 30px;">仪器数增长趋势</div>
        <div  style="padding-top: 10px;">
            <el-form ref="form" :model="pieForm" >
                <el-row type="flex" class="row-bg" justify="space-around">
                    <el-col>
       ...
       <div class="echart_content" style="border-top:1px solid #ccc;">
        ...
        <div style="border-bottom: 1px solid #ccc;height:30px;line-height: 30px;">仪器活跃度统计</div>
        <div  style="padding-top: 10px;">
            <el-form ref="form" :model="pieForm" >
                <el-row type="flex" class="row-bg" justify="space-around">
                    <el-col>
...
<script type="text/javascript">
	...
	export default{
		components:{pieCharts,lineCharts,barCharts},
		data(){
			return{
				pieForm:{
					type:'',
